<?= $this->extend('templates/template_welcome') ?>
...
<section class="section hero" aria-label="home">
  <div class="container">
    ...
    <figure class="hero-banner" data-reveal="right">
      <img src="<?= base_url('volti_assets/images/hero-banner.png'); ?>" width="1116" height="766" alt="Bike" class="w-100">
    </figure>
...
<section class="section about" aria-labelledby="about-label">
  <div class="container">
    ...
    <figure class="about-banner" data-reveal="left">
      <img src="<?= base_url('volti_assets/images/about-banner-1.jpg'); ?>" width="380" height="382" loading="lazy" alt="about banner"
        class="w-100 img-1">

      <img src="<?= base_url('volti_assets/images/about-banner-2.jpg'); ?>" width="347" height="349" loading="lazy" alt="about banner"
        class="w-100 img-2">
    </figure>
...
<section class="section stats" aria-label="statistics">
  <div class="container">
    ...
    <div class="stats-banner" data-reveal>
      <img src="<?= base_url('volti_assets/images/stats-banner.jpg'); ?>" width="1398" height="565" loading="lazy" alt="video banner"
        class="img-cover">
  ...
  <div class="container">
    ...
    <div class="wrapper">
      ...
      <figure class="service-banner img-holder" style="--width: 805; --height: 510;">
        <img src="<?= base_url('volti_assets/images/service-banner.png'); ?>" width="805" height="510" loading="lazy" alt="service banner"
          class="img-cover">
      </figure>
...
<section class="cta">
  <div class="container">
    ...
    <figure class="cta-banner" data-reveal="right">
      <img src="<?= base_url('volti_assets/images/cta-banner.jpg'); ?>" width="330" height="206" loading="lazy" alt="cta banner"
        class="img-cover">
    </figure>
    ...
    <ul class="blog-list" data-reveal>
      ...
      <li>
        <div class="blog-card">
          ...
          <figure class="card-banner img-holder" style="--width: 770; --height: 550;">
            <img src="<?= base_url('volti_assets/images/blog-1.jpg'); ?>" width="770" height="550" loading="lazy"
      ...
      <li>
        <div class="blog-card">
          ...
          <figure class="card-banner img-holder" style="--width: 770; --height: 550;">
            <img src="<?= base_url('volti_assets/images/blog-2.jpg'); ?>" width="770" height="550" loading="lazy"
      ...
      <li>
        <div class="blog-card">
          ...
          <figure class="card-banner img-holder" style="--width: 770; --height: 550;">
            <img src="<?= base_url('volti_assets/images/blog-3.jpg'); ?>" width="770" height="550" loading="lazy"
